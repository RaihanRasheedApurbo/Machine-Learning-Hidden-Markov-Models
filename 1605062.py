...
def viterbi(number_of_states, observations, initial_probabilites, emission_function, transition_probabilites, state_names):
    t1 = [[]] * number_of_states  # number of states amount of one d array
    t2 = [[]] * number_of_states
    k = number_of_states
    t = len(observations)
...
x = viterbi(number_of_states,observations,initial_probabilites,emission_function,transition_matrix, state_names)
logger.info(len(x))
for i in range(10):
    print(x[i])
